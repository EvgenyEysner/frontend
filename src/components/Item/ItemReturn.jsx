...
export const ItemReturn = ({id, name, image, description, ean, stock, onStock, category}) => {
  const {returns, addToReturns, incrementReturnQuantity, decrementReturnQuantity, removeReturnItem} = useReturnStore()
  const currentItem = returns.find((el) => el.id === id)
              ...
              <>
                <div className={styles.cartItem__incrDec}>
                  <IconButton
                    ...
                    onClick={() => decrementReturnQuantity(id)}
                  >
                    <RemoveIcon/>
                  </IconButton>
